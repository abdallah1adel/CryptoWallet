...
class DeveloperPreview {
    ...
    let stat1 = StatisticModel(title: "Market Cap", value: "$11.17Bn", persentageChange: 22.25)
    let stat2 = StatisticModel(title: "Total Volume", value: "$11.02Tr")
    let stat3 = StatisticModel(title: "Portfolio view", value: "$60.2K", persentageChange: -12.34)
